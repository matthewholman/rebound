...
void predictkep(orbstruct* restrict const orb, //struct reb_simulation* r,
...
#ifndef _INTEGRATOR_ENCKE_H
#define _INTEGRATOR_ENCKE_H
void reb_integrator_encke_part1(struct reb_simulation* r);              ///< Internal function used to call a specific integrator
void reb_integrator_encke_part2(struct reb_simulation* r);              ///< Internal function used to call a specific integrator    
void reb_integrator_encke_synchronize(struct reb_simulation* r);        ///< Internal function used to call a specific integrator
void reb_integrator_encke_clear(struct reb_simulation* r);              ///< Internal function used to call a specific integrator
void reb_integrator_encke_alloc(struct reb_simulation* r);              ///< Internal function, alloctes memory for ENCKE
void reb_integrator_encke_reset(struct reb_simulation* r);          ///< Internal function used to call a specific integrator
#endif
